...
<img src="https://latex.codecogs.com/svg.latex?\Large&space;y_i=\frac{e^{x_i}}{\sum_{j=1}^ne^{x_j}}" title="\Large y_i=\frac{e^{x_i}}{\sum_{j=1}^ne^{x_j}}" style="background-color:black; color:white;" />
